...
function FuncComp(props) {
  ...
  // side effect
  useEffect(function(){
    console.log('%cfunc => number (componentDidMount & componentDidUpdate) ' +(++funcId), funcStyle);
    document.title = number;
    return function() {
  ...
  useEffect(function(){
    console.log('%cfunc => _date (componentDidMount & componentDidUpdate) ' +(++funcId), funcStyle);
